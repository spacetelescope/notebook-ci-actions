...
uses: mgough-970/dev-actions/.github/workflows/notebook-ci-unified.yml@v1.2.3
```
...
uses: mgough-970/dev-actions/.github/workflows/notebook-ci-unified.yml@v2.0.0-beta.1
```
...
jobs:
  ci:
    uses: mgough-970/dev-actions/.github/workflows/notebook-ci-unified.yml@v2
    with:
      python-version: "3.11"
      execution-mode: "full"
...
jobs:
  ci:
    uses: mgough-970/dev-actions/.github/workflows/notebook-ci-unified.yml@${{ github.event.inputs.workflow_version || 'v1' }}
```
