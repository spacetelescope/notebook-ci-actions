...
uses: your-org/dev-actions/.github/workflows/ci_pipeline.yml@v2.0.0-beta.1
```
...
jobs:
  ci:
    uses: your-org/dev-actions/.github/workflows/ci_pipeline.yml@${{ github.event.inputs.workflow_version || 'v1' }}
```
